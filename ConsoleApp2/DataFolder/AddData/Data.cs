...
public class Data
{
   public static Random rnd = new Random();
        ...
        using (SQLiteConnection connection = new SQLiteConnection(connectionString))
        {
            ...
            using (var transaction = connection.BeginTransaction())
            {
                ...
                for (int i = 1; i <= 137; i++)
                {
                   ...
                   List <Employee> employees = GenerateRandomEmployees(numberOfEmployees);

                    // Generate random product data based on income balance and business size
                    List <Product> products = GenerateRandomProducts(numberOfProducts, isLargeBusiness);
    ...
    public static int GenerateUniqueSalary()
    {
        Random rnd = new Random();
    ...
    public static List <Product> GenerateRandomProducts(int numberOfProducts, bool isLargeBusiness)
    {
    ...
    public static int GenerateRandomPrice(bool isLargeBusiness)
    {
    ...
    public static void SaveDataToDatabase(SQLiteConnection connection, Store store)
    {
